...
Visibility.onVisible(function() {
    ...
    setTimeout(function(){
      $(".introduction-interna h1").addClass("animated fadeInDown");
    }, 400);
    
    setTimeout(function(){
      $(".introduction-interna p").addClass("animated fadeInDown");
    }, 800);
    setTimeout(function(){
      $(".animar-interna").addClass("animated fadeInDown");
    }, 1600);
});
...
$('.formphp').on('submit', function() {
	var emailContato = "elementartec@gmail.com"; // Escreva aqui o seu e-mail
